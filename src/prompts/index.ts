export const promptList = [
  ...
  },
  {
    ...
    icon: 'i-lucide-cpu',
    title: {
      English: 'Automation Engineer',
      Vietnamese: 'Sinh viên Tự động hóa'
    },
    description: {
      English: 'Tailor CV for Automation & Hardware roles (Factory Automation, Project Quality, or Embedded Systems).',
      Vietnamese: 'Đánh giá CV và viết CV cho sinh viên Tự động hóa hướng Phần cứng (Nhà máy/Chất lượng công trình hoặc Hệ thống nhúng).'
    },
    instructions: {
      English: [
        'Select the target language for your CV in the formatting settings.',
        'Copy the system prompt below and paste it into Gemini or ChatGPT.',
        'Provide the Job Description (JD) and details of your hardware/automation projects.',
        'Choose your specific path (Factory/Project Quality or Embedded Systems) and answer AI questions on PLC, SCADA, hardware design, or firmware.',
        'Copy the final JSON block from the AI, paste it below, and click Import.'
      ],
      Vietnamese: [
        'Chọn ngôn ngữ mục tiêu cho CV của bạn trong phần cài đặt định dạng.',
        'Sao chép prompt hệ thống bên dưới và dán vào Gemini hoặc ChatGPT.',
        'Cung cấp Mô tả công việc (JD) và chi tiết các đồ án/dự án phần cứng hoặc tự động hóa của bạn.',
        'Chọn định hướng cụ thể (Nhà máy/Chất lượng công trình hoặc Hệ thống nhúng) và trả lời các câu hỏi của AI về PLC, SCADA, thiết kế mạch phần cứng hoặc lập trình firmware.',
        'Sao chép khối JSON kết quả cuối cùng từ AI, dán vào phần Import bên dưới và nhấn Import.'
      ]
    }
  }
...
export type PromptId = typeof promptList[number]['id']
...
export interface PromptItem {
  ...
  readonly instructions: {
    ...
    readonly Vietnamese: readonly string[]
  }
}
